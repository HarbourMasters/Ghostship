...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_LEVEL_SSL] = RandoRegion{ .regionName = "Shifting Sand Land", .levelId = LEVEL_SSL,
        .checks = {
            ...
            CHECK(RC_SSL_RED_COIN_01, true),
            CHECK(RC_SSL_RED_COIN_02, true),
            CHECK(RC_SSL_RED_COIN_03, true),
            CHECK(RC_SSL_RED_COIN_04, true),
            ...
            CHECK(RC_SSL_STAR_04_FOUR_PILLARS, true),
