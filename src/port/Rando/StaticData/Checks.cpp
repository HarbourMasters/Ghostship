...
std::map<RandoCheckId, RandoStaticCheck> Checks = {
    ...
    RC(RC_CMC_RED_COIN_01,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    200, -291, -5600),
    RC(RC_CMC_RED_COIN_02,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    980, 260, -3430),
    RC(RC_CMC_RED_COIN_03,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    -540, -352, -5940),
    RC(RC_CMC_RED_COIN_04,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    -300, 450, -6240),
    RC(RC_CMC_RED_COIN_05,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    -200, -400, -6680),
    RC(RC_CMC_RED_COIN_06,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    250, 450, -6400),
    RC(RC_CMC_RED_COIN_07,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    540, -361, -6340),
    RC(RC_CMC_RED_COIN_08,      RCTYPE_MAJOR,   LEVEL_COTMC,        RI_COIN_RED,    980, 260, -3810),
    RC(RC_SNL_RED_COIN_01,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    4750, 1061, -5230),
    RC(RC_SNL_RED_COIN_02,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    416, 1050, -4522),
    RC(RC_SNL_RED_COIN_03,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    -6560, 2040, -5080),
    RC(RC_SNL_RED_COIN_04,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    -6760, 2040, -1360),
    RC(RC_SNL_RED_COIN_05,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    -6880, 1857, 1000),
    RC(RC_SNL_RED_COIN_06,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    -4211, 1092, -4723),
    RC(RC_SNL_RED_COIN_07,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    -6271, 1390, 4764),
    RC(RC_SNL_RED_COIN_08,      RCTYPE_MAJOR,   LEVEL_SL,           RI_COIN_RED,    -529, 1050, -5329),
