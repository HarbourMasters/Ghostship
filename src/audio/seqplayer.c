                    ...
                    if (layer->portamento.mode != 0) {
                        ...
                        if (instrument != NULL) {
                            ...
                            sound = (u8)vel < instrument->normalRangeLo    ? &instrument->lowNotesSound
                                    : (u8)vel <= instrument->normalRangeHi ? &instrument->normalNotesSound
                ...
                if (cmd >= 0x80) {
                    ...
                    switch (cmd & 0xf0) {
                        ...
                        case 0x10:
                            ...
                            if (func_sh_802f47c8(seqChannel->bankId, (u8)value, &seqChannel->soundScriptIO[loBits]) ==
                                -1) {}
                            break;
#else
            ...
            if (cmd >= 0xc0) {
                switch (cmd) {
                    ...
                    case 0xda: // seq_changevol
                        temp = m64_read_u8(state);
                        seqPlayer->fadeVolume = seqPlayer->fadeVolume + (f32)(s8)temp / US_FLOAT(127.0);
                        break;
#endif
