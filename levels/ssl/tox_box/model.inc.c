...
ALIGNED8 static const Texture ssl_seg7_texture_0700BFA8[] = "__OTR__levels/ssl/8";

// 0x0700C7A8 - 0x0700D7A8
ALIGNED8 static const Texture ssl_seg7_texture_0700C7A8[] = "__OTR__levels/ssl/9";

// 0x0700D7A8 - 0x0700E7A8
ALIGNED8 static const Texture ssl_seg7_texture_0700D7A8[] = "__OTR__levels/ssl/10";

// 0x0700E7A8 - 0x0700F7A8
ALIGNED8 static const Texture ssl_seg7_texture_0700E7A8[] = "__OTR__levels/ssl/11";
